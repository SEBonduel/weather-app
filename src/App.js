      ...
      <AnimatePresence mode="wait">
        {!city && (
          ...
          >
            ...
            <p className="ml-6 mr-6 text-l mb-2 lg:text-3xl md:text-2xl sm:text-2xl mb-4">Recherchez une ville pour voir la météo en temps réel ainsi que sur les 4 prochains jours.</p>
            <p className="ml-6 mr-6 text-l mb-2 lg:text-3xl md:text-2xl sm:text-2xl mb-16">Vous pouvez préciser de quel pays il s'agit dans la recherche en cas d'homonyme, par exemple : "Brest, France".</p>
