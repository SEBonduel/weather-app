      ...
      <AnimatePresence mode="wait">
        {!city && (
          ...
          >
            ...
            <p className="ml-6 mr-6 text-l mb-2 lg:text-3xl md:text-2xl sm:text-2xl mb-12">Vous pouvez préciser de quel pays il s'agit dans la recherche en cas d'homonyme, par exemple : "Brest, France".</p>
